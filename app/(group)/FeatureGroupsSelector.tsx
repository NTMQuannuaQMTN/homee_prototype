    ...
    <GradientBackground>
      <View style={tw`flex-1 px-4 pt-14 pb-10`}>
        <View style={tw`flex-row items-center mb-4`}>
          ...
          <Text style={[tw`text-white text-[16px]`, { fontFamily: 'Nunito-ExtraBold' }]}>Select up to 5 favorite groups:</Text>
        </View>
        {notEnoughGroups ? (
          <View style={tw`flex-1 justify-center items-center -mt-15`}>
            ...
            <Text style={[tw`text-white text-[16px] text-center mx-6`, { fontFamily: 'Nunito-Medium' }]}>Come back and select your favorite once you've joined 5 groups!</Text>
          </View>
        ) : (
          <>
            <FlatList
